...
Git repository (such as a published workspace on the teaching repository
or a public repository on GitHub.com) to a *new* workspace on the Auckland Physiome
...
instance (or any non-publicly accessible Git repository), you will need
to use your Git client to directly :term:`push` your repository up to
